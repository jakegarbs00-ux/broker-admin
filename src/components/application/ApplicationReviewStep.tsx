...
export function ApplicationReviewStep({ formData, onEdit, onSubmit, isSubmitting, applicationId }: ApplicationReviewStepProps) {
        ...
        <div className="px-5 py-4 space-y-3">
          ...
          {documentCounts.other > 0 && (
            <div className="flex justify-between">
              ...
              <span className="text-sm font-medium text-slate-900">
                {documentCounts.other} file{documentCounts.other !== 1 ? 's' : ''}
              </span>
            </div>
          )}
        </div>
